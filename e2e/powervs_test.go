...
var _ = Describe("Cluster API IBMPowerVS MachineSet", Ordered, func() {
	...
	BeforeAll(func() {
		...
		createIBMPowerVSClusterCluster(cl, mapiMachineSpec)
	})
...
func createIBMPowerVSClusterCluster(cl client.Client, mapiProviderSpec *mapiv1.PowerVSMachineProviderConfig) *ibmpowervsv1.IBMPowerVSCluster {
	...
	powerVSCluster := &ibmpowervsv1.IBMPowerVSCluster{
		...
		Spec: ibmpowervsv1.IBMPowerVSClusterSpec{
			...
			Network: ibmpowervsv1.IBMPowerVSResourceReference{
				Name: pointer.String("DHCPSERVERrdr-kn85-j4k4f_Private"),
			},
		},
	}
